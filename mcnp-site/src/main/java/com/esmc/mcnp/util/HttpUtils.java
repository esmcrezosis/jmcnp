...
public class HttpUtils {
    ...
    /**
    * Envoyez une demande de méthode GET à l'URL spécifiée
    *
    * @param url URL pour envoyer la demande
    * Paramètres de requête @param param, les paramètres de requête doivent être sous la forme name1 = value1 & name2 = value2.
    ...
    * @param url URL pour envoyer la demande
    * Paramètres de requête @param param, les paramètres de requête doivent être sous la forme name1 = value1 & name2 = value2.
    * @param contentType type de codage
    * @return représente le résultat de la réponse de la ressource distante
    */
    ...
    /**
    * Envoyez une demande de méthode POST à ​​l'URL spécifiée
    *
    * @param url URL pour envoyer la demande
    * Paramètres de requête @param param, les paramètres de requête doivent être sous la forme name1 = value1 & name2 = value2.
    * @return représente le résultat de la réponse de la ressource distante
