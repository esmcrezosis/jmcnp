...
public class Convert {
	 ...
	 * The converted value
	 * @param defaultValue
	 * Default value when conversion error
	 * @return result
	 */
	...
	/**
	 * Convert the object to a string<br>
	 * 1. Byte array and ByteBuffer will be converted into corresponding string array 2. Object array will call Arrays.toString method
	 *
	 * @param obj
	 * Object
	 * @param charsetName
	 ...
	 * String
	 * @param charset
	 * Character set, if this field is empty, the result of decoding depends on the platform
	 ...
	 * Data
	 * @param charset
	 * Character set, if it is empty, use the current system character set
	 * @return string
	 */
