...
public class FileUtils {
    ...
    public static void zip(@NonNull List<Path> fileToZips, @NonNull ZipOutputStream zipOut)
            throws IOException {
        for (Path fileToZip : fileToZips) {
                // Open file to be zipped
                // Create zip entry for target file
    ...
    public static ZipOutputStream zipFiles(@NonNull List<Path> fileToZips,
    ...
    public static void checkDirectoryTraversal(@NonNull Path parentPath, @NonNull Path pathToCheck) {
        ...
        throw new ForbiddenException("Accès refusé à ce chemein :  " + pathToCheck).setErrorData(pathToCheck);
    }
