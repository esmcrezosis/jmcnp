...
public class ExcelPOIHelper {
    ...
    public Map<Integer, List<MyCell>> readExcel(InputStream in, String extension) throws IOException {

        Map<Integer, List<MyCell>> data = new HashMap<>();

        if (extension.equals("xls")) {
            data = readHSSFWorkbook(in);
        } else if (extension.equals("xlsx")) {
            data = readXSSFWorkbook(in);
        }
    ...
    public Map<Integer, List<MyCell>> readHSSFWorkbook(InputStream is) throws IOException {
        Map<Integer, List<MyCell>> data = new HashMap<>();
    ...
    public Map<Integer, List<MyCell>> readXSSFWorkbook(InputStream is) throws IOException {
