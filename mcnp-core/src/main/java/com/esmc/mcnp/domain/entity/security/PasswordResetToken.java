...
public class PasswordResetToken {
    ...
    @OneToOne(targetEntity = EuUtilisateur.class, fetch = FetchType.EAGER)
    ...
    public PasswordResetToken(final String token, final EuUtilisateur user) {
        super();
    ...
    public void setUser(final EuUtilisateur user) {
        this.user = user;
    }
